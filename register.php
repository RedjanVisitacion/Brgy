...
<link rel="stylesheet" href="assets/plugins/fontawesome-free/css/all.min.css">
  ...
  background-image: url('assets/logo/red14.jpg');
  ...
  <nav class="main-header navbar navbar-expand-md " style="background-color: #0037af">
    <div class="container">
      <a href="" class="navbar-brand">
        <img src="assets/dist/img/elecom.png" alt="logo" class="brand-image img-circle " >
        <span class="brand-text  text-white"  style="font-weight: 700">ELECTORAL COMMISSION</span>
      </a>
